...
from core.common.exceptions import InvalidAmount, InvalidTimeRange
    ...
    def test_create_service_item_with_invalid_percentage(self) -> None:
        for _ in range(10):
            with self.assertRaises(InvalidAmount):
                ...
                DataFactory.create_service_items_invalid_percentage()
    ...
    def test_create_service_item_with_invalid_date(self) -> None:
       for _ in range(10):
            with self.assertRaises(InvalidTimeRange):
                #crear el servicio con un porcentaje de pago inválido
                DataFactory.create_service_items_invalid_time()
